...
\begin{document}
	...
	\begin{bidbox}{\orauction{1c,1d,1h,?}}
	\begin{description}
	...
	\begin{bidbox}{\orauction{1c,1d,2n,?}}
		20--21, as per 2NT opener
	\end{bidbox}

	\begin{bidbox}{\orauction{1c,1d,Other}}
...
%%%%
	...
	\begin{bidbox}{\orauction{1c,1s,1n,?}}
		\begin{description}
		\item[\cl2] 5+ \clubsuit.  \di2 TaJ (UPH extra values step), other natural with no special follow ups. \rem{New suits 5 cards?}
