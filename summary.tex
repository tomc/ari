...
\begin{description}
	...
	\item[\he2/\sp2] 3-9, 5 card suit common NV, 7 card suit uncommon but possible Vul
	\item[2NT] 22-23
...
\rem{Updated CIRKLE. KCs down to 2, using a mod 4 instead of mod 5. Hopefully more compressed to allow better space usage. This is closer to classical controls with trump honors (K and Q) getting a bonus. Also, ABCD tie-breaker order tweaked from Game Order to Up-The-Line. (Noted in SQUARE)}
