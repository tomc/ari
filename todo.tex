...
\begin{document}
	...
	\end{itemize}
         ...
         \begin{description}
             \item[(\sp1)-X-(\sp2)-X] With some partners, I have played that this double is takeout, and \he3 by doubler promises 5 \heartsuit while 2NT is artificial showing 4 hearts. See discussion: http://bridgewinners.com/article/view/1s-x-2s-x-minors-or-can-it-have-hearts/              
         \end{description}
