...
For now we are playing Option 2.  I have transcribed the USBF Multi notes; after review we may choose that instead.  \rem{Note that they are done.}
...
%%%%%%%%%%
	...
	\begin{bidtable}{\compauct{3x,3n,p}}
		\cl4 & Size ask. \di4=One suited, otherwise \he4/\sss/NT=min/med/max \\
		\di4/\hhh & Xfer \\
		\sp4 & Suggestion:  Xfer to \ccc \\
